...
import ss.ageofcrafters.blocks.BlockAlloyingTable;
import ss.ageofcrafters.main.AgeOfCrafters;
import ss.ageofcrafters.recipes.Alloys;

public class TileEntityAlloyingTable extends TileEntity implements ISidedInventory{
	...
	public TileEntityAlloyingTable(){
	...
	public boolean isItemValidForSlot(int slot, ItemStack is) {
		return slot == 3 ? false : (slot == 1 || slot == 2 ? hasItemPower (is) : true);
	}
	...
	public void updateEntity(){
		...
		if(!worldObj.isRemote){
			...
			if(flag != this.isAlloying()){
				flag1 = true;
				BlockAlloyingTable.updateBlockState(this.isAlloying(), this.worldObj, this.xCoord, this.yCoord, this.zCoord);
			}
		}
		if(flag1){
			this.markDirty();
