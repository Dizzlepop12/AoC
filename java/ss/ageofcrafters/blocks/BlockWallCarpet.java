...
public class BlockWallCarpet extends BlockLadder{

	public BlockWallCarpet(Material material){
		super();
	}
	@SideOnly(Side.CLIENT)
	public void registerBlockIcons(IIconRegister register){
		this.blockIcon = register.registerIcon("minecraft" + ":" + "wool_colored_" + this.getUnlocalizedName().substring(16));
	}
