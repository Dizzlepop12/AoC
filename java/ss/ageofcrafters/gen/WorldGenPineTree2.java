...
public class WorldGenPineTree2 extends WorldGenAbstractTree{

	public WorldGenPineTree2(Block wood, Block leaves, int metaWood, int metaLeaves, boolean doBlockNotify, int minTreeHeight, int randomTreeHeight, boolean vinesGrow) {
		super(false);
	}
	...
	public boolean generate(World world, Random random, int x, int y, int z) {
		...
		if(block != Blocks.grass && block != Blocks.dirt) {
			...
			int baselength = 0+ random.nextInt(4);
			int branches = 8 ;
    ...
    public void generateTop(World world, int x, int y, int z){
    	...
    	Block leaves = AgeOfCraftersBlocks.ConePineLeaves;
